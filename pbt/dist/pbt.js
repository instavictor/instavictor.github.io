...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var FIT = __webpack_require__(162); // FIT jsx view frag
	var DOT = __webpack_require__(164); // FIT jsx view frag
	...
	var Brain = React.createClass({
	  ...
	  onFilterRowChanged: function onFilterRowChanged(category, price) {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(FIT, { data: this.props.data, store: this.state.store, onFilterChanged: this.onFilterChanged }),
	      React.createElement(DOT, { data: this.props.data, activeFilter: this.state.colorFilter, store: this.state.store, onFilterChanged: this.onFilterRowChanged })
	    );
	  }
	});
	...
	var pewpew = {
	  display: function display(data) {
	    ReactDOM.render(React.createElement(Brain, { data: data }), document.getElementById('ttr'));
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var FIT = React.createClass({
	  ...
	  handleFilterNameChange: function handleFilterNameChange(event) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        ' ',
	        React.createElement('input', { type: 'text', name: 'filterName', onChange: this.handleFilterNameChange }),
	        ' ',
	        React.createElement(
	          'button',
	          { id: 'label', onClick: this.addFilter },
	          'ADD'
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          'table',
	          { cellPadding: '0' },
	          React.createElement(FITRows, { data: this.props.store, onFilterChanged: this.props.onFilterChanged })
	        )
	      )
	    );
	  }
	...
	**/
	var FITRows = React.createClass({
	  ...
	  */
	  ...
	  render: function render() {
	    var resultNodes = Object.keys(this.props.data).map((function (result) {
	      return React.createElement(
	        'tr',
	        { style: { backgroundColor: this.props.data[result].color }, key: result, ref: result, onClick: this.handleClick.bind(this, result) },
	        React.createElement(
	          'td',
	          null,
	          this.props.data[result].hotkey,
	          ' ',
	          result
	        ),
	        React.createElement(
...
/***/ function(module, exports) {
	...
	config.defaultLabels.food = { color: 'cadetblue', spent: 0, hotkey: '1' };
	config.defaultLabels.market = { color: 'coral', spent: 0, hotkey: '2' };
	config.defaultLabels.party = { color: 'salmon', spent: 0, hotkey: '3' };
	config.defaultLabels.clothes = { color: 'lightgreen', spent: 0, hotkey: '4' };
	config.defaultLabels.travel = { color: 'lightblue', spent: 0, hotkey: '5' };
	...
	*/
	...
	var DOT = React.createClass({
	  ...
	  */
	  ...
	  resetBackgroundColor: function resetBackgroundColor(target) {
	  ...
	  render: function tableRowRender() {
	    var commentNodes = this.props.data.map((function nodeMap(comment) {
	      return React.createElement(
	        'tr',
	        { style: { backgroundColor: 'transparent' }, key: comment.id, 'data-index': comment.id, onMouseUp: this.handleClick },
	        React.createElement(
	          'td',
	          null,
	          comment.purchase
